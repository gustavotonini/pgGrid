			 ...
			 char *completionTag)
{
	 ...
	 */
	//elog(NOTICE, "PGGRID: Completion tag");
	if (completionTag)
	{
		Oid			lastOid;
	...
	//elog(NOTICE, "PGGRID: After trigger");
	 ...
	 */
	//elog(NOTICE, "PGGRID: ExecutorEnd");
	ExecutorEnd(queryDesc);
	//elog(NOTICE, "PGGRID: Free desc");
	FreeQueryDesc(queryDesc);
	//elog(NOTICE, "PGGRID: Free snapshot");
		  ...
		  char *completionTag)
{
	...
	PG_TRY();
	{
		...
		{
			case PORTAL_ONE_SELECT:
				//elog(NOTICE, "PGGRID: PortalRunSelect1");
				(void) PortalRunSelect(portal, true, count, dest);
				//elog(NOTICE, "PGGRID: PortalRunSelect1 fim");
			...
			case PORTAL_UTIL_SELECT:
				 ...
				 */
				//elog(NOTICE, "PGGRID: PortalRunSelect2");
				(void) PortalRunSelect(portal, true, count, dest);
				//elog(NOTICE, "PGGRID: PortalRunSelect2 fim");
				...
				DestReceiver *dest)
{
	 ...
	 */
			//elog(NOTICE, "PGGRID: query desc");
	queryDesc = PortalGetQueryDesc(portal);
			//elog(NOTICE, "PGGRID: query desc fim");
	...
	if (forward)
	{
		...
		else
		{
			...
			//elog(NOTICE, "PGGRID: exec 2");
			ExecutorRun(queryDesc, direction, count);
			//elog(NOTICE, "PGGRID: exec 2 fim");
	...
	else
	{
		...
		{
			ActiveSnapshot = queryDesc->snapshot;
			//elog(NOTICE, "PGGRID: executor run");
			ExecutorRun(queryDesc, direction, count);
			//elog(NOTICE, "PGGRID: executor run fim");
			nprocessed = queryDesc->estate->es_processed;
		}
