...
check_xact_readonly(Node *parsetree)
{
	...
	switch (nodeTag(parsetree))
	{
		...
		case T_CreateServerStmt:
		case T_CreateFragmentStmt:
		case T_DropFragmentStmt:
		case T_DropServerStmt:
		case T_PlaceStmt:
		case T_IndexStmt:
			   ...
			   char *completionTag)
{
	...
	switch (nodeTag(parsetree))
	{
		...
		case T_CreateServerStmt:
			CreateServer((CreateServerStmt *) parsetree);
			break;
		case T_DropServerStmt:
			DropServer((DropServerStmt *) parsetree);
			break;			
		case T_CreateFragmentStmt:
			CreateFragment((CreateFragmentStmt *) parsetree, queryString);
			break;
		case T_DropFragmentStmt:
			DropFragment((DropFragmentStmt *) parsetree, queryString);
			break;			
		case T_PlaceStmt:
			Place((PlaceStmt *) parsetree, queryString);
			break;
		...
		default:
			elog(ERROR, "utility unrecognized node type: %d",
...
CreateCommandTag(Node *parsetree)
{
	...
	switch (nodeTag(parsetree))
	{
		...
		case T_CreateServerStmt:
			tag = "CREATE PGGRID SERVER";
			break;
			
		case T_DropServerStmt:
			tag = "DROP PGGRID SERVER";
			break;			
			
		case T_CreateFragmentStmt:
			tag = "CREATE PGGRID FRAGMENT";
			break;
			
		case T_DropFragmentStmt:
			tag = "DROP PGGRID FRAGMENT";
			break;			

		case T_PlaceStmt:
			tag = "PLACE PGGRID FRAGMENT";
			break;
