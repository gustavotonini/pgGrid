...
%type <node>	stmt schema_stmt
		...
		CreateDomainStmt CreateFragmentStmt CreateGroupStmt CreateOpClassStmt
		CreateOpFamilyStmt AlterOpFamilyStmt CreatePLangStmt
		CreateSchemaStmt CreateSeqStmt CreateServerStmt CreateStmt CreateTableSpaceStmt
		...
		DropAssertStmt DropFragmentStmt DropTrigStmt DropRuleStmt DropCastStmt DropRoleStmt
		DropUserStmt DropdbStmt DropServerStmt DropTableSpaceStmt ExplainStmt FetchStmt
		...
		AlterTSConfigurationStmt AlterTSDictionaryStmt PlaceStmt

%type <node>	select_no_parens select_with_parens select_clause
				simple_select values_clause fragment_select_target_list
...
%token <keyword> ABORT_P ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	FRAGMENT FREEZE FROM FULL FUNCTION
	...
	PARSER PARTIAL PASSWORD PLACE PLACING PLANS PORT POSITION
	PRECISION PRESERVE PREPARE PREPARED PRIMARY
	PRIOR PRIVILEGES PROCEDURAL PROCEDURE

	QUOTE

	READ REAL REASSIGN RECHECK RECOVERY REFERENCES REINDEX RELATIVE_P RELEASE RENAME
...
/*****************************************************************************
 *
 * Place a pgGrid fragment on a server
 *
 *****************************************************************************/
...
PlaceStmt:
			PLACE name ON name 
				{
					PlaceStmt *y = makeNode(PlaceStmt);
					y->fragment = $2;
					y->server = $4;
					$$ = (Node *)y;
				}
...
/*****************************************************************************
 *
 * Create a new pgGrid Fragment
 *
 *****************************************************************************/
CreateFragmentStmt:
			CREATE opt_or_replace FRAGMENT name ON name 
				fragment_select_target_list	where_clause
				{
					CreateFragmentStmt *y = makeNode(CreateFragmentStmt);
					y->fragment = $4;
					SelectStmt *n = makeNode(SelectStmt);
					
					y->select_clause = (Node *)n;
...
fragment_select_target_list: '(' target_list ')' { $$ = $2; }
	| /*EMPTY*/ { $$ = NIL; }
...
DropFragmentStmt: DROP FRAGMENT name
				{
					DropFragmentStmt *n = makeNode(DropFragmentStmt);
					n->fragmentname = $3;
					$$ = (Node *) n;
				}
...
/*****************************************************************************
 *
 * Create a new pgGrid Server
 *
 *****************************************************************************/
CreateServerStmt:
			CREATE opt_or_replace SERVER name HOST name PORT Port RECOVERY PORT Port
				{
					CreateServerStmt *n = makeNode(CreateServerStmt);
					n->server = $4;
					n->host = $6;
					n->port = $8;
					n->recoveryport = $11;
 ...
 *
 * 		QUERY :
 *				DROP SERVER <fragment>
 *
 ****************************************************************************/

DropServerStmt: DROP SERVER name
				{
					DropServerStmt *n = makeNode(DropServerStmt);
					n->servername = $3;
					$$ = (Node *) n;
				}
