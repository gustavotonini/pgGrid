...
SeqNext(SeqScanState *node)
{
	...
	//elog(NOTICE, "PGGRID: ExecStoreTuple?");
	 ...
	 */
	//elog(NOTICE, "PGGRID: chegou no heap_getnext?");
	tuple = heap_getnext(scandesc, direction);
	//elog(NOTICE, "PGGRID: chegou no heap_getnext fim?");
	 ...
	 */
	if (tuple){
	//elog(NOTICE, "PGGRID: chegou no storetuple?");
		ExecStoreTuple(tuple,	/* tuple to store */
					   slot,	/* slot to store in */
					   scandesc->rs_cbuf,		/* buffer associated with this
												 * tuple */
					   false);	/* don't pfree this pointer */
	//elog(NOTICE, "PGGRID: fim storetuple");
	}else{
		//elog(NOTICE, "PGGRID: fim das tuplas?");
		ExecClearTuple(slot);
		
		//elog(NOTICE, "PGGRID: fim fim das tuplas?");
	}
