...
static const struct cachedesc cacheinfo[] = {
	...
	{FragmentRelationId,			/* FRAGMENTNAME */
		FragmentNameIndexId,
		0,
		1,
		{
	...
	{FragmentRelationId,			/* FRAGMENTRELID */
		FragmentRelIndexId,
		0,
		1,
		{
			Anum_pg_grid_fragment_relid,
			0,
			0,
			0
		},
	...
	{AllocationRelationId,			/* ALLOCFRAGMENTID */
		AllocFragmentIndexId,
		0,
		1,
		{
			Anum_pg_grid_allocation_frag_id,
			0,
			0,
			0
		},
	...
	{SiteRelationId,			/* SITEID */
		SiteIdIndexId,
		0,
		1,
		{
			Anum_pg_grid_site_oid,
			0,
			0,
			0
		},
