...
DECLARE_UNIQUE_INDEX(pg_grid_site_name_index, 3777, on pg_grid_site using btree(sitename name_ops));
#define SiteNameIndexId	3777

DECLARE_UNIQUE_INDEX(pg_grid_fragment_name_index, 3778, on pg_grid_fragment using btree(fragmentname name_ops));
#define FragmentNameIndexId	3778

DECLARE_INDEX(pg_grid_fragment_relid_index, 3779, on pg_grid_fragment using btree(relid oid_ops));
#define FragmentRelIndexId	3779

DECLARE_INDEX(pg_grid_allocation_fragid_index, 3780, on pg_grid_allocation using btree(fragmentid oid_ops));
#define AllocFragmentIndexId	3780

DECLARE_UNIQUE_INDEX(pg_grid_site_id_index, 3781, on pg_grid_site using btree(siteid oid_ops));
