...
#define PACKAGE_STRING "PostgreSQL 8.3.0"
...
#define PG_VERSION_STR "PostgreSQL 8.3.0 on x86_64-unknown-linux-gnu, compiled by GCC gcc (Ubuntu/Linaro 4.6.3-1ubuntu5) 4.6.3"
...
/* PGCluster version */
#define PGCLUSTER_VERSION "1.9.0rc5"
