...
/*
 * Pg Grid server manipulation statements
 */

typedef struct CreateServerStmt
{
	NodeTag		type;
...
typedef struct CreateFragmentStmt
{
	NodeTag		type;
	char	   *fragment;			/* fragment name */
